    ...
    <script>
      window.fbAsyncInit = function() {
        ...
        FB.Event.subscribe('auth.login', function() {
		  ...
		  //window.top.location = 'http://dressupfiesta.com/socialgame/demis/';
...
{
	echo "<script>window.top.location = 'http://dressupfiesta.com/socialgame/demis/logout.php'</script>";
...
<span class="facebook-connect">
  ...
  <span class="f-name"><?php echo $me['name']; ?></span><br />
   ...
   <span class="f-picture"><img src="<?php echo $photo; ?>" width="50" height="50"/></span><br />
      <a href="<?php echo $logoutUrl; ?>" >     
      <img src="images/facebook-logout.jpg">
    </a>
...
<a href="#?w=470" rel="registeration" class="register poplight" onMouseOver="document.images['s4a'].src='images/register-over.png';" onMouseOut="document.images['s4a'].src='images/register.png';"> <img src="images/register.png" name="s4a" /></a>
<?php } ?>

<?php if((!isset($_SESSION['FACEBOOK_ID'])) && (!isset($_SESSION['USER_ID'])) && ($me['id'] =='')) { ?>
<a href="#?w=470" rel="login" class="login poplight" onMouseOver="document.images['s3a'].src='images/login-over.png';" onMouseOut="document.images['s3a'].src='images/login.png';"><img src="images/login.png" name="s3a" /></a>
<?php } ?>
<?php if((!isset($_SESSION['FACEBOOK_ID'])) && (isset($_SESSION['USER_ID'])) && ($me['id'] =='')) { ?>
<a href="logout.php" rel="login" class="login poplight" onMouseOver="document.images['s5a'].src='images/logout-over.png';" onMouseOut="document.images['s5a'].src='images/logout.png';"><img src="images/logout.png" name="s5a"  /></a>
<?php } ?>
