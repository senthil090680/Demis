...
$attachment = array(
	  ...
	  'href' => 'http://apps.facebook.com/nieveenlima/',
	  // Descripción que lo acompaña en color gris
	  'description' => $description,
	  // Nombre de la captura (sin documentacion)
	  'caption' => '{*actor*} está aportando a que haya Nieve en Lima!',
	  ...
	  'media' => array(
		...
		array(
		  ...
		  'type' => 'image',
		  // url de la imagen
		  'src' => 'http://nieveenlima.pe/juego_dev/default_fb.png',
		  // link de la imagen
		  'href' => 'http://apps.facebook.com/nieveenlima/'
		)
	  )
...
//	$facebook->api('/me/feed', 'POST', array('message'=> $message, 'description'=> $description, 'picture'=> 'http://nieveenlima.pe/juego_dev/images/default_fb.png',  'cb' => ''));
*/	
