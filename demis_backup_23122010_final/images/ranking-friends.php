 ...
 <div class="tableContainer_friends">
   <div class="table-body_friends">
	  <div class="table-row_friends">
    	...
    	<span class="user-avatar_friends"><img src="images/facebook-icon.png" style="vertical-align:middle; height:30px; width:50px;" /></span>
	  </div>
  </div>
 </div>
...
<span class="user-avatar_friends style="position:relative; float:left"><img src="<?php echo $USER_IMAGE; ?>" width="50" height="50"/></span>
	<div class="tableContainer_friends" style="position:relative; float:right">
   		<div class="table-body_friends">
		  <div class="table-row_friends">
		    <span class="f-name_friends"><?php echo $FIRSTNAME . " " .  $LASTNAME; ?></span>
            <br/>
		    <span class="total-score_friends"><?php echo $SCORE . " copos"; ?></span>
	  	  </div>
  		</div>
 	</div>
  </div>
...
<span class="user-avatar_friends style="position:relative; float:left"><img src="<?php echo $USER_IMAGE; ?>" width="50" height="50"/></span>
	<div class="tableContainer_friends" style="position:relative; float:right">
		  ...
		  <div class="table-row_friends">
		    <span class="f-name_friends"><?php echo $FIRSTNAME . " " .  $LASTNAME; ?></span>
            <br/>
		    <span class="total-score"><?php echo $SCORE . " copos"; ?></span>
	  	  </div>
  		</div>
 	</div>
  </div>
