...
else
{
	...
	$num_sf=mysql_num_rows($results1);
         ...
         <form name="occur" method="post" onSubmit="return occureditvalidate(this);" class="niceform" enctype="multipart/form-data">
                <fieldset>                
                	 ...
                	 <dl>
                        ...
                        <dd><?php $i=1; while ($rowcnt2 = mysql_fetch_array($results1)) { ?>
                            <?php $sf_val[$i] = $rowcnt2[SNOWFLAKE_ID];
								  if($num_sf == $i) 
								  { 
								echo $rowcnt2[SNOWFLAKE_DESC]."."; } else {
								echo $rowcnt2[SNOWFLAKE_DESC].","; } ?><?php $i++; }?>
                ...
                <input type="hidden" name="level_old"  id="level_old" value="<?PHP echo $rowcnt[LEVEL_ID]; ?>">
                    <dl>
                        ...
                        <dd><input class="text" type="text" name="occurrence"  id="occurrence" value="<?PHP echo $rowcnt['OCCURRENCE'];?>" size="54"></dd>
