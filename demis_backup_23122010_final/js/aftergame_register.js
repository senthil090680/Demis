...
{	
	...
	if(msg1.value=="")
		...
		var url="email_friends_ajax.php?email="+email1.value+"&score="+score1+"&subj="+subj1.value+"&msg="+msg1.value;	
		//alert(url);
		xmlHttp.onreadystatechange=function()
      {
		...
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="Complete")
			...
			//alert(xmlHttp.responseText);
				...
				if(i == 0)
				{
					var msg = "Your message has not been sent due to some errors";
					document.getElementById('error_msg3').innerHTML = msg;
					return false;										
				}
				else if(i == 1)
				{
					var msg = "Your message has been sent successfully to your friends";
					//alert(msg);
					document.getElementById('error_msg3').innerHTML = msg;
					return false;										
				}
